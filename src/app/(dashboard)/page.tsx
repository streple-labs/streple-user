...
export default function page() {
  return (
    <div className="flex flex-col gap-10 w-full hide-scrollbar overflow-y-auto">
      <h5 className="text-xl leading-5">Hello Benita,</h5>
      <div className="flex gap-6">
        <div className="w-2/3 space-y-10">
          <div className="h-[176px] bg-[url('../../public/balance-bg.png')] bg-center bg-contain bg-no-repeat rounded-[20px] py-6 px-8 flex flex-col justify-between">
          ...
          <div className="py-4 px-6 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-y-3 gap-x-12">
              <div className="flex items-center gap-2">
                <span className="size-[42px] gradient-border rounded-full bg-white/5 flex items-center justify-center">
