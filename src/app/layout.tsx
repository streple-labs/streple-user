...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://app.streple.com",
    siteName: "Streple",
    images: [
      {
        url: "https://app.streple.com/opengraph-image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://app.streple.com/opengraph-image.png"],
    creator: "@StrepleNetwork",
  },
  metadataBase: new URL("https://app.streple.com"),
  robots: {
    index: true,
    follow: true,
    googleBot: {
