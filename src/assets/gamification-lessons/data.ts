  ...
  1: [
    {
      ...
      transcript:
        "Welcome, Pioneer, to Streple's Digital Frontier, where money's past meets its wild future. You're about to explore a world where wealth isn't just coins or cash. It's the future of finance, and you're one of the first explorers.\nMoney has changed a lot. It first started with trading shells, grain. Then people switched to gold.\nThen paper money was controlled by banks. Today, digital money is the new currency. It lives online, powered by blockchain, meaning decentralized ownership.\nSo no single person controls it. It's fast, global, and open to everyone. This is the rise of neobanking and borderless payments processing.\nWell done, Pioneer. You've taken your first step into the future of finance. Keep exploring to unlock more secrets.\nWith Streple, you're shaping the future of finance, powered by decentralized ownership and borderless innovation.\n",
    },
    {
      title: "Understanding wallets",
      src: "https://streplestorage.s3.eu-north-1.amazonaws.com/videos/streple-crypto-101.mp4",
      transcript:
        "Let's dive into crypto. Cryptocurrency is a digital money powered by blockchain. It's a safe system shared across thousands of computers.\nThis makes Bitcoin the first decentralized cash. Ethereum is more than money. It's a platform for apps and smart contracts.\nCoins run on their own blockchains, while tokens live on platforms like Ethereum. They can also be stablecoins, rewards, or other power apps. This is the engine of borderless payments and the future of finance.\nYay! You've just mastered Crypto 101. The frontier is getting clearer. Keep exploring the future of finance.",
    },
    {
      title: "Crypto in the market",
      src: "https://streplestorage.s3.eu-north-1.amazonaws.com/videos/streple-digital-ownership.mp4",
      transcript:
        "Now we move to digital ownership. Here, you can own art, land, or even a slice of the metaverse. Let's explore.\nIn the digital world, ownership is proven on the blockchain. NFTs are unique digital items like art or tickets. Good news is, you can also own tokenized assets like shares in real estate.\nIn the metaverse, you can buy land, build a shop, or host events. Keep this in mind. You're not just owning.\n You're creating value in a whole new world. Congratulations! You've claimed your stake in the digital frontier. With Strepl, you're shaping the future of finance, powered by decentralized ownership and borderless innovation.",
    },
  ],
  2: [],
};

const P1L1quizFormQuestions: Record<
  number,
...
const P1L2quizFormQuestions: Record<
  number,
  { question: string; options: string[]; answer: number; info: string }
> = {
  1: {
...
const P1L3quizFormQuestions: Record<
  number,
  { question: string; options: string[]; answer: number; info: string }
> = {
  1: {
...
const P2L1quizFormQuestions: Record<
  number,
  { question: string; options: string[]; answer: number; info: string }
> = {
  1: {
...
const P2L2quizFormQuestions: Record<
  number,
  { question: string; options: string[]; answer: number; info: string }
> = {
  1: {
...
export const test_data = {
  1: [P1L1quizFormQuestions, P1L2quizFormQuestions, P1L3quizFormQuestions],
  2: [],
};
